...
namespace :dump do
  ...
  task static_data: :environment do
    ...
    sh 'tar -cvzf db/encrypted_data/static_data.tar.gz tmp/static_data.sql.enc'
  ...
  task sample_data: :environment do
    ...
    sh 'tar -cvzf db/encrypted_data/sample_data.tar.gz tmp/sample_data.sql.enc'
    sh 'rm tmp/sample_data.*'
  end

  desc 'Runs all database tasks'
  task all: %w[static_data sample_data]
end
