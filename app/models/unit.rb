class Unit < ApplicationRecord
  ...
  def self.types
    %w(
      Faculty Institute VocationalSchool Academy Department ScienceDiscipline ArtDiscipline InterdisciplinaryDiscipline
      Discipline Rectorship ResearchCenter
    )
  end
  ...
  # delegations
  delegate :undergraduate_programs, :master_programs, :doctoral_programs, :interdisciplinary_master_programs,
           :interdisciplinary_doctoral_programs, :proficiency_in_art_programs, to: :programs
end