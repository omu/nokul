...
class EducationInformation < ApplicationRecord
  ...
  validates :end_date_of_thesis, allow_nil: true, numericality: { only_integer:             true,
  ...
  validates :start_date_of_thesis, allow_nil: true, numericality: { only_integer:             true,
                                                                    greater_than_or_equal_to: 1950,
                                                                    less_than_or_equal_to:    2050 }
