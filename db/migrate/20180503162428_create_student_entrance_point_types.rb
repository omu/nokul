...
class CreateStudentEntrancePointTypes < ActiveRecord::Migration[5.2]
  def change
    ...
    add_null_constraint :student_entrance_point_types, :code
    ...
    add_unique_constraint :student_entrance_point_types, :name
    add_unique_constraint :student_entrance_point_types, :code
  end
end
