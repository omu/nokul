...
class CreateEducationInformations < ActiveRecord::Migration[6.0]
  def change
    ...
    add_length_constraint :education_informations, :unit_name, less_than_or_equal_to: 255
    ...
    add_length_constraint :education_informations, :university_name, less_than_or_equal_to: 255
    ...
    add_numericality_constraint :education_informations, :university_id, greater_than_or_equal_to: 0
