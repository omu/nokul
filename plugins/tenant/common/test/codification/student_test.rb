  ...
  module Tenant
    module Codification
      class StudentTest < ActiveSupport::TestCase
        test 'student_short_number_generator works' do
        ...
        test 'student_short_number_generator unit_code sanitization works' do
          assert_raise(ArgumentError) do
            Student.short_number_generator(unit_code: '20', year: '19', starting: '023')
          end
        end

        test 'student_short_number_generator year sanitization works' do
          assert_raise(ArgumentError) do
            Student.short_number_generator(unit_code: '203', year: '2019', starting: '023')
          end
        end

        test 'student_short_number_generator starting sanitization works' do
          assert_raise(ArgumentError) do
            Student.short_number_generator(unit_code: '203', year: '19', starting: '23')
          end
        end

        test 'student_short_number_generator can handle a blank or zero starting' do
        ...
        test 'student_long_number_generator works' do
        ...
        test 'student_long_number_generator starting sanitization works' do
          assert_raise(ArgumentError) do
