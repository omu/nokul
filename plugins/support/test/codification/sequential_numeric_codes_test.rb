    ...
    module  Codification
      class SequentialNumericCodesTest < ActiveSupport::TestCase
        test 'simple use case works' do
          coder = Codification.sequential_numeric_codes 1
        ...
        test 'simple use case with memory works' do
          ...
          coder = Codification.sequential_numeric_codes 1, memory: memory
          assert_equal '0001', coder.run
          assert_equal '0002', coder.run

          other = Codification.sequential_numeric_codes 1, memory: memory
