...
module Nokul
  module Support
    class CodificationsGeneratorTest < ActiveSupport::TestCase
      ...
      test 'can generate pools' do
        generator = Codifications::Generator.new '000', ends: '002'
      ...
      test 'can deny certain symbols based on a regex pattern' do
        ...
        # complex case
        generator = Codifications::Generator.new '000', ends: '999', deny: /(?<digit>)\g<digit>\g<digit>/
